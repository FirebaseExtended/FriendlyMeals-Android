...
class AppConfigDataSource @Inject constructor(
    ...
    private fun getLocalDefault(key: String): String {
        return when (key) {
            ...
            "ingredients_prompt" -> "Please analyze this image and list all visible food ingredients. Output ONLY a comma-separated list of ingredients. Do not include any introductory text, headers, or concluding remarks. Provide the raw list only. Be specific with measurements where possible."
